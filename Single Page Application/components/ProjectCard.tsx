...
import { EditorIcon, ShareIcon } from '../constants';
...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, onShareClick }) => {
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden flex flex-col group animate-fadeInUp">
      <div className={`w-full overflow-hidden bg-gray-50 p-3`} style={{ aspectRatio: project.aspectRatio.replace(':', ' / ') }}>
        <img 
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <p 
          className="text-sm text-gray-500 mb-4 h-10" // Height for 2 lines of text-sm
          style={{ 
            overflow: 'hidden', 
            display: '-webkit-box', 
            WebkitLineClamp: 2, 
