...
import { XIcon, ShareIcon, DownloadIcon, CopyIcon, CheckIcon } from '../constants';
...
const ShareModal: React.FC<ShareModalProps> = ({ isOpen, onClose, project }) => {
  ...
  const handleNativeShare = async () => {
    try {
      // Salin caption secara proaktif ke clipboard sebagai solusi
      ...
      if ((error as DOMException).name !== 'AbortError') {
          ...
          alert('Gagal membagikan konten. Silakan coba lagi.');
      }
    }
  };
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl shadow-xl w-full max-w-md transform transition-all animate-fadeInUp"
